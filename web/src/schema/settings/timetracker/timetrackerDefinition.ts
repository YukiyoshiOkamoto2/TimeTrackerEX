...
- nonduplicate: 重複しない場合は長く、重複する場合は短く`,
        ...
        timeOffEvent: new ObjectSettingValueInfo({
            name: "休暇イベントの設定",
            ...
            children: {
                namePatterns: new ArraySettingValueInfo({
                    ...
                    required: true,
                    itemType: "object",
                    itemSchema: new ObjectSettingValueInfo({
                        name: "パターン設定",
        ...
        ignorableEvents: new ArraySettingValueInfo({
            name: "無視可能イベント",
        ...
        eventDuplicatePriority: new ObjectSettingValueInfo({
            name: "イベント重複時の優先判定",
...
- large: 時間が長いイベントを優先(より大きく登録)`,
        ...
        scheduleAutoInputInfo: new ObjectSettingValueInfo({
            name: "勤務時間の自動入力設定",
