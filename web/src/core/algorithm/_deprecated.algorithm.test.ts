 ...
 * - TimeTrackerAlgorithmEvent.ts (cleanDuplicateEvent, margedScheduleEvents)
 * - TimeTrackerAlgorithmSchedule.ts (splitOneDayTask, scheduleToEvent)
 *
 * 各モジュールの新しいテストは以下を参照:
 * - TimeTrackerAlgorithmHelper.test.ts (Event, Schedule関連のテスト)
 */
